...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedSites(){
        ...
        foreach( $this->arraySites as $sitios){
            $s = new Site;
            $s->titulo = $sitios['titulo'];
            $s->imagen = $sitios['imagen'];
            $s->descripcion1 = $sitios['descripcion1'];
            $s->descripcion2 = $sitios['descripcion2'];
            $s->video= $sitios['video'];
            $s->save();
    ...
    private $arraySites = array(
        array(
            'titulo' => 'Tumaco',
            'imagen' => 'https://i.pinimg.com/originals/20/48/26/204826583bceb39b3aff88635116b2a3.jpg',
            'descripcion1' => 'Para empezar, vamos con un destino con mucho sabor y alegría, se trata de Tumaco.
            ...
            'descripcion2' => 'Los principales atractivos turísticos de Tumaco son las playas del Morro con su imponente arco natural.
        ...
        array(
            'titulo' => 'Santuario Nuestra Señora de las Lajas',
            'imagen' => 'https://viajes.nationalgeographic.com.es/medio/2019/04/08/santuario-de-las-lajas_6ed0eca2_800x800.jpg',
            'descripcion1' => 'El Santuario Nuestra Señora de las Lajas es uno de los sitios turísticos de Nariño más visitado por turistas del mundo entero.',
            'descripcion2' => 'Esta iglesia de estilo gótico es conocida como ‘Un milagro de Dios en el abismo’. Por esto fue declara en 2007 como la segunda maravilla de Colombia.
        ...
        array(
            'titulo' => 'Laguna de la Cocha',
            'imagen' => 'http://kahuaritravel.com.co/wp-content/uploads/2016/01/Imagen-Destacada-Laguna-La-Cocha-Kahuari.jpg',
            'descripcion1' => 'Seguimos con un templo de agua. La laguna de la Cocha es el segundo cuerpo de agua natural más grande de Colombia, después del lago de Tota. Está ubicada a tan solo 40 minutos de Pasto.',
            'descripcion2' => 'Esta laguna se encuentra en el sistema de páramos más bajo del mundo y, entre la vegetación que lo rodea, se encuentran frailejones. En la laguna hay un embarcadero colorido donde se pueden encontrar restaurantes donde preparan truchas arcoiris, toda una delicia.
        ...
        array(
            'titulo' => 'Parque Sanquianga',
            'imagen' => 'http://awsassets.panda.org/img/original/8057487393_d5252437be_k.jpg',
            'descripcion1' => 'Estos ecosistemas costeros tienen la capacidad de almacenar más carbono que muchos bosques tropicales y protegen las costas de los tsunamis y del alza del nivel del mar.',
            'descripcion2' => 'Nariño es tierra de contrastes. El parque Sanquianga está bañado por las aguas del océano Pacífico. Se trata de uno de los bosques de manglares más grande del mundo. Tiene más de 80.000 hectáreas y acá se encuentran el 20% de los manglares de Colombia. El parque es hogar de sesenta clases de peces, treinta tipos de moluscos, una veintena de especies de aves y doce tipos de reptiles.',
            'video' => 'https://youtu.be/cLZxmZ4eav4'
        ),
        array(
            'titulo' => 'Laguna Verde',
            'imagen' => 'https://www.turismopasto.com/wp-content/uploads/2018/04/plan-turistico-narino-maximo-laguna-verde.jpg',
            'descripcion1' => 'La laguna Verde es considerada como una de las lagunas más bellas del mundo y uno de los sitios turísticos más importantes de Nariño',
            'descripcion2' => 'Está ubicada en el Volcán Azufral, en el municipio de Túquerres, a 90 minutos de Pasto.
        ...
        array(
            'titulo' => 'Volcán Galeras',
            'imagen' => 'http://hablemosdevolcanes.com/wp-content/uploads/2018/10/volcan-galeras-4.jpg',
            'descripcion1' => ' Está ubicado a 9 km de Pasto y es el volcán con mayor actividad en el país. En sus faldas existe un santuario de fauna y flora y sus riscos son locación idónea para hacer montañismo.',
            'descripcion2' => 'El Santuario cuenta con dos senderos, El Frailejonal y el Achichay. Acá los turistas pueden entender importancia del ecosistema de páramo. Además se les enseñan aspectos sobre la conservación de este y la importancia del agua. Como resultado de esta riqueza, cerca del Galeras hay 125 quebradas, varios ríos y cuatro lagunas.
        ...
        array(
            'titulo' => 'Cañón de Juanambú',
            'imagen' => 'https://buesaconarino.micolombiadigital.gov.co/sites/buesaconarino/content/files/000045/2240_parque-canon-de-juanambu_1024x600.jpg',
            'descripcion1' => ' El Cañón de Juanambú está ubicado a 54 kilómetros de Pasto, entre los municipios de Buesaco y Arboleda',
            'descripcion2' => 'Entre sus atracciones ofrece la oportunidad de realizar deportes acuáticos como canotaje de travesía, kayak, natación en río y en piscinas naturales.
